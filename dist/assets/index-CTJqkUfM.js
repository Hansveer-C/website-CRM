(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function a(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(n){if(n.ep)return;n.ep=!0;const o=a(n);fetch(n.href,o)}})();const O=[{id:"1",name:"John Doe",email:"john@example.com",phone:"555-0101",status:"Job Scheduled",lastContact:"2026-02-23",service:"Full House Wash"},{id:"2",name:"Jane Smith",email:"jane@smithresidence.com",phone:"555-0202",status:"Lead",lastContact:"2026-02-24",service:"Driveway Cleaning"},{id:"3",name:"Solar Power Co.",email:"ops@solarpower.com",phone:"555-0303",status:"Quote Sent",lastContact:"2026-02-22",service:"Solar Panel Wash"}],T=[{id:"residential-sparkle",name:"Residential Sparkle",description:"Perfect for soft washing and home exterior care specialist.",theme:{primary:"#00d2ff",secondary:"#3a7bd5",font:"Inter"},blocks:[{id:"h1",type:"hero",data:{title:"The Cleanest House on the Block",subtitle:"Professional Soft Washing & Gutter Cleaning in Los Angeles.",buttonText:"Get My Free Estimate"}},{id:"s1",type:"services",data:{title:"Residential Services",items:["House Washing","Roof Cleaning","Gutter Brightening","Driveway Sealing"]}},{id:"c1",type:"contact",data:{title:"Request a Residential Quote"}}]},{id:"commercial-pro",name:"Commercial Pro",description:"Industrial bold styling for large-scale concrete and fleet cleaning.",theme:{primary:"#ff4b2b",secondary:"#ff416c",font:"Roboto"},blocks:[{id:"h2",type:"hero",data:{title:"Industrial Strength Cleaning",subtitle:"Reliable Fleet and Concrete Maintenance for Commercial Properties.",buttonText:"Schedule a Consultation"}},{id:"s2",type:"services",data:{title:"Commercial Solutions",items:["Fleet Washing","Dumpster Pad Cleaning","Parking Lot Restoration","Graffiti Removal"]}},{id:"t2",type:"trust",data:{title:"Trusted by Local Business Leaders",logos:["Starbucks","Walmart","Local Mall"]}}]},{id:"trust-proof",name:"The Trust Proof",description:"Heavy focus on before/after galleries and client testimonials.",theme:{primary:"#11998e",secondary:"#38ef7d",font:"Outfit"},blocks:[{id:"h3",type:"hero",data:{title:"See the Difference for Yourself",subtitle:"Real Results. Real Reviews. Real Experts.",buttonText:"View Our Gallery"}},{id:"g3",type:"gallery",data:{title:"Recent Successes",images:["Before/After 1","Before/After 2","Before/After 3"]}},{id:"t3",type:"trust",data:{title:"What Your Neighbors Say",testimonials:[{name:"Alice R.",text:"Best service ever!"},{name:"Bob S.",text:"My driveway looks new."}]}}]}],h=[{id:"c1",name:"John Doe",phone:"555-0101",email:"john@example.com",address:"123 Pine St, Seattle, WA",tags:["residential","referral"],source:"Google Search",status:"customer",created_at:"2026-02-15T10:00:00Z"},{id:"c2",name:"Jane Smith",phone:"555-0202",email:"jane@smithresidence.com",address:"456 Oak Ave, Portland, OR",tags:["lead","driveway"],source:"Facebook Ad",status:"lead",created_at:"2026-03-01T14:30:00Z"}],S=[{id:"p1",name:"Residential Cleaning Pipeline",stages:["New Lead","Quote Sent","Scheduled","Completed","Paid"]}],c=[{id:"o1",contact_id:"c2",pipeline_stage:"New Lead",value:250,assigned_to:"Hansveer",status:"open",created_at:"2026-03-01T14:35:00Z"},{id:"o2",contact_id:"c1",pipeline_stage:"Completed",value:450,assigned_to:"Hansveer",status:"won",created_at:"2026-02-15T10:05:00Z"}],k=[{id:"a1",contact_id:"c2",type:"call",description:"Initial follow-up call about driveway cleaning",due_date:"2026-03-02T09:00:00Z",completed:!0},{id:"a2",contact_id:"c2",type:"sms",description:"Sent quote via text",due_date:"2026-03-05T10:00:00Z",completed:!1}],I=[{id:"a1",name:"Auto-follow task for new leads",trigger:"OPPORTUNITY_CREATED",action:"CREATE_TASK",actionParams:{type:"call",description:"Call new lead ASAP",dueInMinutes:10}},{id:"a2",name:"Notify when job is scheduled",trigger:"OPPORTUNITY_STAGE_UPDATED",condition:e=>e.pipeline_stage==="Scheduled",action:"SEND_NOTIFICATION",actionParams:{message:"🎉 A job has been scheduled! Get ready."}},{id:"a3",name:"Final follow up when completed",trigger:"OPPORTUNITY_STAGE_UPDATED",condition:e=>e.pipeline_stage==="Completed",action:"CREATE_TASK",actionParams:{type:"visit",description:"Site cleanup & final inspection",dueInDays:0}},{id:"a4",name:"Follow up on sent quote",trigger:"OPPORTUNITY_STAGE_UPDATED",condition:e=>e.pipeline_stage==="Quote Sent",action:"CREATE_TASK",actionParams:{type:"note",description:"Follow up on quote in 24 hours",dueInDays:1}}];function A(e,t){I.filter(i=>i.trigger===e&&(!i.condition||i.condition(t))).forEach(i=>{L(i,t)})}function L(e,t){switch(e.action){case"CREATE_TASK":R(e.actionParams,t);break;case"SEND_NOTIFICATION":E(e.actionParams,t);break}}function R(e,t){const a=h.find(r=>r.id===t.contact_id),i=a?a.name:"Unknown",n=new Date;e.dueInDays&&n.setDate(n.getDate()+e.dueInDays),e.dueInMinutes&&n.setMinutes(n.getMinutes()+e.dueInMinutes);const o={id:"task-"+Date.now()+"-"+Math.floor(Math.random()*1e3),contact_id:t.contact_id,type:e.type||"note",description:e.description||`[AUTOMATED] Follow up for ${i}`,due_date:n.toISOString(),completed:!1};k.push(o),console.log(`[AUTOMATION: TASK CREATED] ${o.description}`)}function E(e,t){const a=h.find(o=>o.id===t.contact_id),i=a?a.name:"Unknown",n=e.message.replace("${contactName}",i);console.log(`%c[AUTOMATION: NOTIFICATION] ${n} (${i})`,"color: #007bff; font-weight: bold;"),alert(`Automation Notification: ${n}`)}const g=document.querySelector("#app");let C="dashboard",v=T[0],d=[...v.blocks];function f(e){return`
  ...
  `}function _(){const e=new Date,t=c.filter(s=>s.status==="open"),a=t.reduce((s,l)=>s+l.value,0),i=t.length,n=c.length,o=c.filter(s=>s.status==="won").length,r=n>0?o/n*100:0,u=S[0].stages.map(s=>{const l=c.filter(m=>m.pipeline_stage===s&&(m.status==="open"||m.status==="won")).reduce((m,D)=>m+D.value,0);return{stage:s,value:l}}).filter(s=>s.value>0),y=Math.max(...u.map(s=>s.value),1),w={};h.forEach(s=>{w[s.source]=(w[s.source]||0)+1});const $=Object.entries(w).map(([s,l])=>({source:s,count:l})),P=Math.max(...$.map(s=>s.count),1),x=k.filter(s=>!s.completed&&new Date(s.due_date)<e);g.innerHTML=`
    ${f("dashboard")}
    <main class="main-content">
      ...
      <div class="dashboard-grid" style="grid-template-columns: repeat(4, 1fr);">
        <div class="card">
          ...
          <p class="value" style="color: var(--primary-color);">$${a.toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:0})}</p>
        </div>
        <div class="card">
        ...
        <div class="card" style="border-bottom: 4px solid #ff4444;">
          ...
          <p class="value" style="color: #ff4444;">${x.length}</p>
        </div>
      </div>
            ...
            ${u.map(s=>`
              <div class="report-item">
                ...
                <div class="visual-bar-bg">
                  <div class="visual-bar-fill" style="width: ${s.value/y*100}%"></div>
                </div>
              </div>
          ...
          <div class="chart-container" style="margin-top: 20px;">
            ${$.map(s=>`
              <div class="report-item">
                ...
                <div class="visual-bar-bg">
                  <div class="visual-bar-fill" style="width: ${s.count/P*100}%; background: #6c757d;"></div>
                </div>
              </div>
            `).join("")}
          </div>
      ...
      ${x.length>0?`
        <div class="card" style="margin-top: 30px; border: 1px solid #ffcccc;">
          ...
          <table class="clients-table" style="box-shadow: none; border: 1px solid #eee; margin-top: 20px;">
            ...
            <tbody>
              ${x.map(s=>{const l=h.find(m=>m.id===s.contact_id);return`
      ...
      <header class="view-header">
        <div style="display: flex; align-items: center; gap: 20px;">
          ...
          <select id="template-select" style="padding: 8px; border-radius: 4px; border: 1px solid #ccc;">
            ${T.map(t=>`<option value="${t.id}" ${t.id===v.id?"selected":""}>${t.name}</option>`).join("")}
          </select>
        </div>
        <div>
  ...
  `,(e=document.getElementById("template-select"))==null||e.addEventListener("change",t=>{const a=t.target.value,i=T.find(n=>n.id===a);i&&(v=i,d=[...i.blocks],b())}),document.querySelectorAll(".draggable-item").forEach(t=>{t.addEventListener("click",()=>{const a=t.getAttribute("data-type");window.addBlock(a)})})}function N(){return d.length===0?`<div class="canvas-section" style="border: 2px dashed #007bff; background: #f0f7ff;">
              <p style="color: #007bff;">Click an element to add it here</p>
            </div>`:d.map((e,t)=>{let a="";switch(e.type){case"hero":a=`
          <div class="canvas-hero" style="background: linear-gradient(135deg, ${v.theme.primary}, ${v.theme.secondary});">
            <h1>${e.data.title}</h1>
            <p>${e.data.subtitle}</p>
            <button class="btn-primary" style="background: white; color: ${v.theme.primary}; margin-top: 20px;">${e.data.buttonText}</button>
          </div>
        ...
        `;break;case"contact":a=`
          <div class="canvas-section">
            ...
            <div style="margin-top: 20px; display: flex; flex-direction: column; gap: 10px; max-width: 400px; margin-left: auto; margin-right: auto;">
              ...
              <button class="btn-primary" style="background: ${v.theme.primary}">Send Quote Request</button>
            </div>
          </div>
    ...
    `}).join("")}window.addBlock=e=>{const t={id:Date.now().toString(),type:e,data:M(e)};d.push(t),b()};window.removeBlock=e=>{d.splice(e,1),b()};window.moveBlock=(e,t)=>{const a=e+t;if(a>=0&&a<d.length){const i=d[e];d[e]=d[a],d[a]=i,b()}};function M(e){switch(e){case"hero":return{title:"Insert Title",subtitle:"Insert Subtitle",buttonText:"Click Me"};case"services":return{title:"Our Services",items:["Service 1","Service 2","Service 3"]};case"contact":return{title:"Get In Touch"};case"gallery":return{title:"Our Work",images:["Image 1","Image 2","Image 3"]};case"trust":return{title:"What Clients Say",testimonials:[{name:"John D.",text:"Great Job!"}]};default:return{}}}function j(){g.innerHTML=`
    ${f("reports")}
    <main class="main-content">
      <header class="view-header">
  ...
  `,(e=document.getElementById("lead-form"))==null||e.addEventListener("submit",H)}function H(e){e.preventDefault();const t=document.getElementById("lead_name").value,a=document.getElementById("lead_phone").value,i=document.getElementById("lead_email").value,n=document.getElementById("lead_address").value,o=document.getElementById("lead_service").value,r="c"+(h.length+1),p="o"+(c.length+1);h.push({id:r,name:t,phone:a,email:i,address:n,tags:["new-lead"],source:"Lead Capture Form",service:o,status:"lead",created_at:new Date().toISOString()});const u={id:p,contact_id:r,pipeline_stage:"New Lead",value:0,assigned_to:"Hansveer",status:"open",created_at:new Date().toISOString()};c.push(u),A("OPPORTUNITY_CREATED",u);const y=document.querySelector(".lead-form-container");y&&(y.innerHTML=`
    ...
    `)}function G(){const e=S[0],a=e.stages.map(i=>{const n=c.filter(r=>r.pipeline_stage===i),o=n.map(r=>{const p=h.find(u=>u.id===r.contact_id);return`
  ...
  `}function U(e,t){const a=c.find(i=>i.id===e);a&&(a.pipeline_stage=t,t==="Completed"||t==="Paid"?a.status="won":t==="Lost"?a.status="lost":a.status="open",window.navigateTo(C),console.log(`Opportunity ${e} updated: Stage=[${t}], Status=[${a.status}]`),A("OPPORTUNITY_STAGE_UPDATED",a))}window.allowDrop=e=>{e.preventDefault()};window.drag=(e,t)=>{var a;(a=e.dataTransfer)==null||a.setData("text",t)};window.drop=(e,t)=>{var i;e.preventDefault();const a=(i=e.dataTransfer)==null?void 0:i.getData("text");a&&U(a,t)};window.navigateTo=e=>{C=e,e==="dashboard"&&_(),e==="clients"&&B(),e==="opportunities"&&G(),e==="lead-capture"&&q(),e==="builder"&&b(),e==="reports"&&j(),e==="quickstart"&&F()};_();
