...
// src/test_conversation_summary.ts
...
var summary = getConversationSummary(contactId);
console.log("Summary Result:", summary);
if (summary && summary.last_message_content === "Latest message!" && summary.last_message_direction === "outbound") {
