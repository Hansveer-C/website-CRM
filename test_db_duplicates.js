...
async function testDuplicateProtection() {
  ...
  try {
    ...
    db2.prepare("DELETE FROM contacts WHERE email = 'duplicate@test.com'").run();
    ...
    const countResult = db2.prepare("SELECT count(*) as total FROM contacts WHERE email = 'duplicate@test.com'").get();
