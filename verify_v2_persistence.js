...
async function verifyV2() {
  ...
  try {
    ...
    if (!originalOpp)
      throw new Error("Original opportunity not found");
    ...
    if (reFetchedOpp && reFetchedOpp.contact_id === contactId && reFetchedOpp.pipeline_stage === originalStage && reFetchedContact && reFetchedContact.id === contactId) {
